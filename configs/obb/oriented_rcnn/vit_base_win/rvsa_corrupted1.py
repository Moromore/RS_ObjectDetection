...
# data_root = '/opt/data/private/zsy/RVSA/RSP/Object Detection/DIOR/'
data_root = ''
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        xmltype='obb',
        imgset=data_root + 'Main/trainval.txt',
    ...
    test=dict(
        type=dataset_type,
        xmltype='obb',
        #imgset=data_root + 'Main/test.txt',
        #ann_file=data_root + 'Annotations/Oriented Bounding Boxes',
        #img_prefix=data_root + 'test/',
        imgset=data_root + '/opt/data/private/zsy/RVSA/RSP/Object Detection/DIOR/Main/test.txt',
        ann_file=data_root + '/opt/data/private/zsy/RVSA/RSP/Object Detection/DIOR/Annotations/Oriented Bounding Boxes',
        img_prefix=data_root + '/opt/data/private/zsy/RS_workspace/corrupted_dataset/DIOR_Corrupted/salt_and_pepper_noise/severity_1/',
