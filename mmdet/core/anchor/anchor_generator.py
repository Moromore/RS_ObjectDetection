...
class AnchorGenerator(object):
    ...
    def gen_base_anchors(self):
        ...
        # print(f"self.base_sizes = {self.base_sizes}\ncenter_offset = {self.center_offset}centers={self.centers}")
        for i, base_size in enumerate(self.base_sizes):
            # print(f'i={i}, base_size={base_size}')
            center = None
    ...
    def gen_single_level_base_anchors(self,
        ...
        """
        # print(f"base_size = {base_size}, scales = {scales}, ratios = {ratios}center = {center}")
        w = base_size
        h = base_size
        if center is None:
        ...
        # print(f'base_anchors={base_anchors}')
        return base_anchors
