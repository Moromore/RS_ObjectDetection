...
class SatMAEVisionTransformer(timm.models.vision_transformer.VisionTransformer):
    ...
    def init_weights(self, pretrained=None):
        ...
        pretrained = 'model_zoo/pretrain-vit-large-e199.pth'
    ...
    def forward_features(self, x):
        ...
        for i in range(len(ops)):
            ...
            # features[i].shape = torch.Size([2, 1024, 200, 200])
            # features[i].shape = torch.Size([2, 1024, 100, 100])
            # features[i].shape = torch.Size([2, 1024, 50, 50])
            # features[i].shape = torch.Size([2, 1024, 25, 25])
