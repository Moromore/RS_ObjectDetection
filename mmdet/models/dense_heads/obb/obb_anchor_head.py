...
class OBBAnchorHead(BaseDenseHead):
    ...
    def __init__(self,
        ...
        # print(f"cls_out_channels = {self.cls_out_channels}\nnum_classes = {self.num_classes}")
        # cls_out_channels = 1
        # num_classes = 1
        ...
        # print(f"num_base_anchors = {self.num_anchors}")
        self._init_layers()
        ...
        Returns:
            tuple: Usually a tuple of classification scores and bbox prediction
                ...
                bbox_preds (list[Tensor]): Box energies / deltas for all scale
                    ...
                    num_anchors * 4.
        """
        # print(f"Number of feats: {len(feats)}") #5
    ...
    def _get_targets_single(self,
        ...
        # print(f'num_valid_anchors={num_valid_anchors}') #num_valid_anchors=15
    ...
    def get_targets(self,
        ...
        # print(f'labels_list={labels_list}') #labels_list=[tensor([[0, 0, 0],
        #         [0, 0, 0]], device='cuda:0'), tensor([[0, 0, 0],
        #         [0, 0, 0]], device='cuda:0'), tensor([[0, 0, 0],
        #         [0, 0, 0]], device='cuda:0'), tensor([[0, 0, 0],
        #         [0, 0, 0]], device='cuda:0'), tensor([[0, 0, 0],
        #         [0, 0, 0]], device='cuda:0')]
    ...
    def loss_single(self, cls_score, bbox_pred, anchors, labels, label_weights,
        ...
        # print(f"cls_score: {cls_score.shape}") ([1, 3, 1, 1])
        cls_score = cls_score.permute(0, 2, 3,
                                      1).reshape(-1, self.cls_out_channels)
        # print(f"cls_score: {cls_score.shape}") ([3, 1])
